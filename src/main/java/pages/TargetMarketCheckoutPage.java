...
public class TargetMarketCheckoutPage extends BasePage {
    ...
    @FindBy(xpath = "//input[@id='phoneNumber']/../div']")
...
//    private WebElement phoneNumberMissingAlertMessage;
    ...
    public void placeOrderProcess(String firstname, String lastName, String address, String cardNumber, String phoneNumber){
